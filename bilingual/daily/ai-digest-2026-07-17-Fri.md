[English](../../en/daily/ai-digest-2026-07-17-Fri.md) | [中文](../../zh/daily/ai-digest-2026-07-17-Fri.md) | [Bilingual](./ai-digest-2026-07-17-Fri.md)
...
企业采用 agent 正在从 demo 进入组织改造阶段。Aaron Levie 的企业 IT 晚宴笔记把难点讲得很清楚：权限、数据准备、内部 FDE 式工程角色、无头软件、模型路由，以及安全修复 backlog。

The agent-native engineering stack is becoming a knowledge-infrastructure problem. Teams need skills, docs, memories, public work channels, and automation that let agents inherit domain knowledge instead of asking humans to repeat it.  
agent-native 工程栈越来越像知识基础设施问题。团队需要用 skills、docs、memories、公开工作频道和自动化，把领域知识交给 agent 继承，而不是让人反复口头补上下文。
...
Voice, multimodal, and computer-use interfaces are becoming serious product surfaces. Gemini's Southeast Asia growth, Peter Yang's live assistant critique, and Swyx's CUA argument all point toward more capable action interfaces.  
语音、多模态和 computer-use 正在变成严肃产品界面。Gemini 在东南亚的增长、Peter Yang 对实时助手的批评，以及 Swyx 对 CUA 的判断，都指向更有行动能力的交互界面。
