...
最新日报: ai-digest-2026-09-05-Sat.md [中文](zh/daily/ai-digest-2026-09-05-Sat.md) | [English](en/daily/ai-digest-2026-09-05-Sat.md) | [双语](bilingual/daily/ai-digest-2026-09-05-Sat.md)
...
- 日报：每天 16:30（Asia/Shanghai）。即使 GitHub 将定时任务延迟到午夜之后，日报仍使用原定的上海时区调度日期。
- 周报：每周一 18:30（Asia/Shanghai）。它会在等待周一上游更新后，将历史 feed 去重并汇总为上一个完整的周一至周一自然周。上游内部最多六小时的时间缺口会在周报中明确披露；更大的缺口或窗口末端缺失会阻止发布。
- 成功运行后直接提交到 `main`。
