[English](../../en/daily/ai-digest-2026-09-23-Wed.md) | [中文](./ai-digest-2026-09-23-Wed.md) | [双语](../../bilingual/daily/ai-digest-2026-09-23-Wed.md)
...
- [Thibault Sottiaux: GPT-6 Sol 和 Luna 上线，API 价格永久下调 50%](https://x.com/thsottiaux/status/2102463847714247142)
- [Thibault Sottiaux: 「让所有人都有更高的效率和智能」](https://x.com/thsottiaux/status/2102440619616682120)
- [Thibault Sottiaux: 「Maybe our cutest launch so far」](https://x.com/thsottiaux/status/2102509507415048245)

### Aaron Levie: CEO, Box

Aaron Levie 称这是 AI 领域疯狂的一天：随着 Opus 5.5 降价、GPT-6 Sol 和 Luna 把 token 价格下调 50%，前沿模型一下子便宜了很多。他认为，按同口径计算的单位任务成本下降速度，在技术史上没有先例；而 AI 成本每下降一次，可以用 agent 承接的场景就会大幅增加，他把这种现象称为「Jevons paradox 在 agent 上的体现」。他预计 AI 会因此加速在经济中扩散：用 agent 处理所有数据、扫描代码安全问题、读遍日志做决策、在 workflow 里跑 agent swarm。他还详细介绍了 Box 用 Box Agent 对 Opus 5.5 做的企业级测试：达到前沿能力水平，相比 Opus 5 token 用量减少 63%、冗余表述减少 42%、速度提升 30%，其中金融服务尽职调查任务准确率 +39%、云成本分析 +65%、客户账户分析 +17%、临床诊断 +15%；客户很快可以在 Box AI Studio 里用 Opus 5.5 构建 AI agent。

- [Aaron Levie: 前沿模型更便宜，会打开更多 agent 场景，Jevons paradox 在 agent 上的体现](https://x.com/levie/status/2102477253070430322)
- [Aaron Levie: Box 用 Box Agent 对 Opus 5.5 做的企业级测试](https://x.com/levie/status/2102448415775051790)
...
- [Boris Cherny: 用 Lean 对 Claude Agent SDK 做形式化验证，产出 16 个 PR](https://x.com/bcherny/status/2102543349102338309)
- [Boris Cherny: Opus 5.5 用 9.5 小时把 HAProxy 移植到 Rust，成本比 Fable 5.1 低 51%](https://x.com/bcherny/status/2102439069053747549)
- [Boris Cherny: 「Opus 做了一张信息图」](https://x.com/bcherny/status/2102543350436180277)
...
- [Cat Wu: Claude Opus 5.5 成为 Claude Code 和 Claude app 的新默认模型](https://x.com/_catwu/status/2102437713781944397)
- [Cat Wu: 在 Slack 里试用 Opus 5.5 和 Claude Tag 的途径](https://x.com/_catwu/status/2102569951974584612)
...
- [Guillermo Rauch: 新一轮 Next.js 评测中三个模型并列 97%](https://x.com/rauchg/status/2102519097770885231)
- [Guillermo Rauch: Anthropic 发布产品的品味与推动设计边界](https://x.com/rauchg/status/2102438365455167883)
...
- [Alex Albert: 用一句 Opus 5.5 prompt 在 Blender 里构建整个世界](https://x.com/alexalbert__/status/2102466523164274839)
- [Alex Albert: 那个基于来源数据重现地震前 Market Street 的 prompt](https://x.com/alexalbert__/status/2102466524934271381)
...
- [Thariq: 用模型能力去理解用户，而不是往生产环境塞 10 倍功能](https://x.com/trq212/status/2102548686303854790)
- [Thariq: workflow 现在是他使用 Claude 的重要部分](https://x.com/trq212/status/2102477527688388752)
- [Thariq: 先想清楚游戏循环，再谈 3D 生成](https://x.com/trq212/status/2102549030303867257)
...
- [Garry Tan: Capy 提交 PR 的速度远超单用 Codex 或 Claude Code](https://x.com/garrytan/status/2102544711647129902)
- [Garry Tan: GStack 确实会建议你去申请 YC](https://x.com/garrytan/status/2102537390774759761)
- [Garry Tan: 教全世界写 prompt、把 AI 用到极致](https://x.com/garrytan/status/2102501556348440983)
...
- [Claude: Claude Opus 5.5 今天上线](https://x.com/claudeai/status/2102471892099866883)
- [Claude: kevin_t_ngo 做的算法绘画程序](https://x.com/claudeai/status/2102471889092276516)
- [Claude: 一个玩具积木搭建应用](https://x.com/claudeai/status/2102471885061812714)
...
- [Aditya Agarwal: AI 最早的安全辩论其实在自动驾驶上](https://x.com/adityaag/status/2102457464432284019)
- [Aditya Agarwal: 在 SPC 接待 Waymo 的 Dmitri Dolgov](https://x.com/adityaag/status/2102498288658526614)
- [Aditya Agarwal: AI 产品应该让人愉悦、好玩](https://x.com/adityaag/status/2102421668509733058)
...
- [Nikunj Kothari: 别再相信融资头条](https://x.com/nikunj/status/2102534909076349291)
- [Nikunj Kothari: 「A Walk In The Park」第三期，嘉宾 Todd Saunders](https://x.com/nikunj/status/2102395699895677325)
- [Nikunj Kothari: 「A Walk In The Park」第三期也已上线 YouTube](https://x.com/nikunj/status/2102409907278602622)

### Dan Shipper: CEO, Every

Dan Shipper 说他一天之内涨了将近 1 万名新粉丝，并举出两篇内容给新读者：他对 Opus 5.5 与 Sol-6 的 vibe check，以及他对 AI 自动化为何会给人类专家创造更多好工作的看法。

- [Dan Shipper: 对 Opus 5.5 与 Sol-6 的 vibe check，以及自动化为何创造更多好工作](https://x.com/danshipper/status/2102556723244564715)
...
- [Peter Steinberger: Astra 在 libuv 里找到一个大约 14 年前的 bug](https://x.com/steipete/status/2102501642176528743)

### Sam Altman: OpenAI CEO

Sam Altman 说，初创公司天生就擅长这件事，而大公司很难一直保持这种能力，他认为这是一个尚未被充分探索的空间。

- [Sam Altman: 初创公司天生擅长大公司难以保持的能力](https://x.com/sama/status/2102469008079679640)
